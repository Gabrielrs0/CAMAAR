...
Funcionalidade: Responder formulário de avaliação
  ...
  Cenário: Responder e enviar um formulário com todos os campos obrigatórios preenchidos
  ...
  Cenário: Preencher respostas opcionais e enviar com sucesso
  ...
  Cenário: Tentar enviar o formulário sem responder perguntas obrigatórias
    Dado que estou na página de um formulário de avaliação
  ...
  Cenário: Inserir texto inválido (muito longo) em uma resposta discursiva
  ...
  Cenário: Tentar enviar o formulário com campos com caracteres inválidos
  ...
  Cenário: Tentar reenviar um formulário já enviado
  ...
  Cenário: Perder conexão com a internet durante o envio
